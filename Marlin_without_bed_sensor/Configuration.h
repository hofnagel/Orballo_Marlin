...
#define STRING_CONFIG_H_AUTHOR "(Ben Whipker, TFD)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,146.9419152276296/2}  // default steps per unit for Ultimaker
